<template>
    <div class="px-4 mb-12">
        ...
        <div class="px-4 my-4 max-w-[650px] mx-auto md:px-1">
            <p class="archivo font-semibold text-lg text-center bg-lime-200 max-w-[400px] mx-auto mb-4 mt-8">A great place
                to start learning about layouts, animations, color choices, and more.</p>
        </div>
    </div>
...
export default {
    ...
    computed: {
        ...
        filteredProjects() {
            return this.level1Projects.filter((project) => project.title.toLowerCase().includes(this.projInput.toLowerCase()))
        }
    }
}
</script>
