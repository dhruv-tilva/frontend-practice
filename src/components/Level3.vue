<template>
    <div class="px-4 mb-12">
        ...
        <div class="px-4 my-4 max-w-[650px] mx-auto md:px-1">
            <p class="archivo font-semibold text-lg text-center bg-amber-400 max-w-[530px] p-1 mx-auto mb-4 mt-8">Test and
                push your skills even further with these complex layouts, animations, and interactive elements.</p>
        </div>
    </div>
...
export default {
    ...
    computed: {
        ...
        filteredProjects() {
            return this.level3Projects.filter((project) => project.title.toLowerCase().includes(this.projInput.toLowerCase()))
        }
    }
}
</script>
